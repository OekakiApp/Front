...
const selectedFontSize = ref<number>(fontSize.value)

// font size入力規制 1~100
const checkFontSize = (value: number): string => {
  let parsedFontSize = value
